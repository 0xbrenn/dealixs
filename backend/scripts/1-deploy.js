...
async function main() {
  console.log("🚀 IOPN DEX Deployment - Step 1: Deploy All Contracts (Except Library)");
  console.log("======================================================================\n");
  ...
  try {
    // 1. Deploy or use existing WETH/WIOPN
    console.log("\n📋 Step 1: WETH/WIOPN");
    console.log("=====================");
    ...
    if (existingContracts.WETH && deploymentConfig.OPTIONS.skipExisting) {
      ...
      console.log("📦 Deploying new WETH/WIOPN...");
    ...
    if (existingContracts.FACTORY && deploymentConfig.OPTIONS.skipExisting) {
      ...
      const Factory = await ethers.getContractFactory("IOPNFactory");
    ...
    if (existingContracts.ROUTER && deploymentConfig.OPTIONS.skipExisting) {
      ...
      const Router = await ethers.getContractFactory("IOPNRouter02");
...
IMPORTANT: Update this in IOPNLibrary.sol before running step 2!
...
`;
    ...
    console.log("2. Open contracts/libraries/IOPNLibrary.sol");
