...
const handleAddLiquidity = useCallback(async () => {
  ...
  try {
    ...
    const amountAMin = amountADesired.mul(1000 - slippageTolerance * 10).div(1000);
    const amountBMin = amountBDesired.mul(1000 - slippageTolerance * 10).div(1000);
    ...
    if (tokenA.address === '0x0000000000000000000000000000000000000000' || 
      ...
      const tokenMin = isTokenAETH ? amountBMin : amountAMin;
    ...
    toast.success(
      <div className="flex flex-col gap-1">
        <span className="font-semibold">Liquidity added successfully!</span>
        <a 
