...
/* Glow effects - Enhanced contrast */
.glow-purple {
  box-shadow: 0 0 40px rgba(34, 197, 94, 0.2), 0 0 80px rgba(8, 145, 178, 0.1);
}

.glow-purple-lg {
  box-shadow: 0 0 60px rgba(34, 197, 94, 0.25), 0 0 120px rgba(8, 145, 178, 0.15);
}
...
/* Button gradient - Enhanced separation */
.gradient-button {
