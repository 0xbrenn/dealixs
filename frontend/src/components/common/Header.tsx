...
<AnimatePresence>
  {showProfileDropdown && (
    <motion.div
      ...
      exit={{ opacity: 0, y: -10 }}
      className="absolute top-full right-0 mt-2 w-80 rounded-xl overflow-hidden shadow-2xl"
      style={{
      ...
      {hasDealixId && dealixProfile ? (
        <>
          ...
          <div className="py-2">
            ...
            <button className="w-full px-4 py-3 flex items-center space-x-3 hover:bg-white/5 transition-colors">
