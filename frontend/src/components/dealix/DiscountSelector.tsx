...
export const DiscountSelector: React.FC<DiscountSelectorProps> = ({
  ...
  console.log('DiscountSelector mounted:', {
    hasSelectFunction: typeof selectDiscount === 'function',
    hasDeselectFunction: typeof deselectDiscount === 'function',
    availableDiscounts: availableDiscounts.length,
    selectedDiscounts: selectedDiscounts
  });

const handlePoolToggle = (poolId: number) => {
  console.log('Toggle discount pool:', poolId);
  console.log('Current selected discounts:', selectedDiscounts);
  
  if (selectedDiscounts.includes(poolId)) {
    console.log('Deselecting discount:', poolId);
    deselectDiscount(poolId);
  } else {
    console.log('Selecting discount:', poolId);
