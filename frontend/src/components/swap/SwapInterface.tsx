        ...
        <div className="relative z-10">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Trade tokens instantly</p>
            </div>
            <motion.button
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center -my-2 relative z-10">
              <motion.button
                ...
                className="p-3 glass glass-hover rounded-2xl border border-white/10 shadow-lg group relative overflow-hidden"
              >
                {/* Gradient background on hover */}
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-600/20 to-cyan-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <svg className="w-5 h-5 text-gray-400 group-hover:text-emerald-400 transition-colors relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {fromAmount && toAmount && parseFloat(fromAmount) > 0 && parseFloat(toAmount) > 0 && (
              ...
              >
                <div className="glass rounded-2xl p-4 space-y-3 border border-emerald-500/10">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-500 text-sm">Slippage Tolerance</span>
                    <span className="text-emerald-400 text-sm font-medium">{slippage}%</span>
                  </div>
                  {/* Optional: Add more trade details */}
                  <div className="pt-2 border-t border-white/5">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-500 text-xs">Min. Received</span>
