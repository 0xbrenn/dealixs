    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div 
              className="glass glow-purple rounded-3xl p-6 max-w-md w-full relative overflow-hidden pointer-events-auto"
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        placeholder="0.5"
                        className="flex-1 glass text-white px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all placeholder-gray-500"
                        step="0.1"
                        min="0"
                        max="50"
                      />
