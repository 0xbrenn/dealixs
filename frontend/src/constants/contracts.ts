...
export const DEALIX_ABI = [
  ...
  // Discount Pools
  "function createDiscountPool(tuple(address,address,uint256,uint256,uint256,uint256,uint256,uint256,bool)) payable returns (uint256)",
  ...
  // Swap Functions
  "function swapWithDealix(tuple(address,address,uint256,uint256,uint256[],uint256)) returns (uint256)",
  ...
  "event DiscountPoolCreated(uint256 indexed poolId, address indexed creator, address tokenA, address tokenB)",
...
export const LIQUIDITY_MANAGER_ABI = [
  ...
  // Liquidity Functions
  "function addLiquidityWithDiscountPool(tuple(address,address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)) returns (uint256 amountA, uint256 amountB, uint256 liquidity, uint256 discountPoolID)",
  
  // Affiliate Functions
  "function createAffiliateDiscount(tuple(address,address,uint256,uint256,uint256,uint256)) returns (uint256)",
  ...
  "function canUseAffiliateDiscount(uint256 discountID, address user) view returns (bool canUse, string memory reason)",
  
  // Project Management
  "function addVerifiedProject(address project)",
  "function removeVerifiedProject(address project)",
  "function verifiedProjects(address) view returns (bool)",
  
  // Events
  "event LiquidityAddedWithDiscount(address indexed provider, address tokenA, address tokenB, uint256 liquidity, uint256 discountPoolID)",
