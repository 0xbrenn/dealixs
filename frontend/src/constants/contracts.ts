...
export const DEALIX_ABI = [
  ...
  // Swap Functions
  "function swapWithDealix(tuple(address tokenIn, address tokenOut, uint256 amountIn, uint256 amountOutMin, uint256[] discountPoolIDs, uint256 affiliateDiscountID)) returns (uint256)",
  "function swapWithoutDealix(address tokenIn, address tokenOut, uint256 amountIn, uint256 amountOutMin) returns (uint256)",
